...
\begin{enumerate}
    ...
    \item \textbf{Sparksee binary not available.} The Sparksee licence file ships with the project but the binary distribution is gated behind a registered-user download. We use Kuzu as a Cypher-portable substitute.
