...
\paragraph{Backend.} Sparksee~5.2.3~\cite{sparksee2024,martinez2017dex}, sourced from Maven Central as \texttt{\seqsplit{com.sparsity:sparkseejava:5.2.3}}. We drive its native Java API from Python via JPype1. A one-shell-command installer (\texttt{scripts/install\_sparksee.sh}) downloads the jar plus a portable Eclipse Temurin~17 JDK into a project-local \texttt{.tools/} directory; no system-level Java install is required. Built on a Tesla~T4 + 4-core CPU host.
